...
output "regional_lambda_functions" {
  ...
  value = {
    ...
    "eu-central-1" = {
      region        = "eu-central-1"
      function_name = try(module.lambda_eu_central_1[0].function_name, null)
      function_arn  = try(module.lambda_eu_central_1[0].function_arn, null)
      invoke_arn    = try(module.lambda_eu_central_1[0].invoke_arn, null)
      role_arn      = try(module.lambda_eu_central_1[0].role_arn, null)
    }
    "ap-southeast-1" = {
      region        = "ap-southeast-1"
      function_name = try(module.lambda_ap_southeast_1[0].function_name, null)
      function_arn  = try(module.lambda_ap_southeast_1[0].function_arn, null)
      invoke_arn    = try(module.lambda_ap_southeast_1[0].invoke_arn, null)
      role_arn      = try(module.lambda_ap_southeast_1[0].role_arn, null)
    }
  }
}
